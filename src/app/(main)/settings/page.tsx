...
const SettingsPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-10 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex justify-between">
          <div className="flex flex-col gap-1">
            <h2 className="text-lg font-semibold">Chủ đề</h2>
            <p className="text-sm text-base-content/70">
              Chọn chủ đề đoạn chat
            </p>
          </div>
          <Link href={"/"}>
            <button className="p-2 rounded-md text-primary bg-red-500">
              Quay về
            </button>
          </Link>
        </div>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">BAO</h3>
                    ...
                    >
                      <div
                        className={`
                          ...
                          ${message.isSent ? "bg-white-500 text-primary-content" : "bg-base-200"}
                        `}
                      >
